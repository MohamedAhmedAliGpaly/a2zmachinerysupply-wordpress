    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <a class="online-quotation" target="_blank" href="http://www.a2zmachinerysupply.com/order/">
                    <img src="<?php echo get_template_directory_uri().'/img/create-online-quotation.png'; ?>">
                </a>
            </div>
        </div>
    </div>
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="<?php echo get_template_directory_uri().'/img/slide/bearing-slide.jpg'; ?>">
            </div>
            <div class="item">
                <img src="<?php echo get_template_directory_uri().'/img/slide/boiler-slide.jpg'; ?>">
            </div>
            <div class="item">
                <img src="<?php echo get_template_directory_uri().'/img/slide/v-belt-slide.jpg'; ?>">
            </div>
            <div class="item">
                <img src="<?php echo get_template_directory_uri().'/img/slide/tools-slide.jpg'; ?>">
            </div>
        </div>
...
<div class="hot-product-wrapper">
    <img src="<?php echo get_template_directory_uri().'/img/hot-product.jpg'; ?>">
</div>
<!--.hot-product-wrapper-->
