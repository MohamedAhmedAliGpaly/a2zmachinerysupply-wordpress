    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-xs-6">
                ...
                <ul class="address">
                    <li><i class="fa fa-map-marker"></i> A2z Machinery Supply, 43/44 Nawabpur Road, Shewli Market, Shop #9 (Nine), Dhaka: 1100, Bangladesh.</li>
                    <li><i class="fa fa-phone"></i> <a href="tel:01676717945">01676-717945</a> </li>
                    <li><i class="fa fa-envelope"></i> <a href="mailto:info@a2zmachinerysupply.com">masudrk2015@gmail.com</a> </li>
                </ul>
            </div>
        </div>
    </div>
