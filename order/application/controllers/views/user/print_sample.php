    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-6 text-right">
                <h1 style="font-weight: 700;">SAMPLE</h1>
            ...
            <div class="col-md-12">
                <table class="table table-bordered table-striped table-condensed" style="margin-top: 30px;">
                    ...
                    foreach($quotation_item_list->result() as $quotation_item){
                        $expected_total += ($quotation_item->quantity_unit * $quotation_item->expected_price);
                        $quoted_total += ($quotation_item->quantity_unit * $quotation_item->quoted_price);
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?php echo $quotation_item->quantity_unit; ?></td>
                            <td class="text-right currency"><?php echo $quotation_item->expected_price; ?></td>
                            <td class="text-right currency"><?php echo ($quotation_item->quantity_unit * $quotation_item->expected_price); ?></td>
                            <td class="text-right currency"><?php echo $quotation_item->quoted_price; ?></td>
                            <td class="text-right currency"><?php echo ($quotation_item->quantity_unit * $quotation_item->quoted_price); ?></td>
                        </tr>
                    <?php } ?>
                    </tbody>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td class="text-right currency" style="font-weight: 700;"><?php echo $expected_total; ?></td>
                        <td></td>
                        <td class="text-right currency" style="font-weight: 700;"><?php echo $quoted_total; ?></td>
                    </tr>
                    </tfoot>
                </table>
