            ...
            <div class="col-md-12">
                <table class="table table-bordered table-striped table-condensed" style="margin-top: 30px;">
                    ...
                    foreach($quotation_item_list->result() as $quotation_item){
                        $total += ($quotation_item->quantity_unit * $quotation_item->quoted_price);
                        ?>
                    ...
                    <tr>
                        ...
                        <td class="text-right currency" style="font-weight: 700;"><?php echo $total; ?></td>
                    </tr>
                    </tfoot>
                </table>

                <p class="text-center"><span style="font-weight: bold;">In word:</span> <?php echo convert_number_to_words($total).'.'; ?></p>
                <p></p>
