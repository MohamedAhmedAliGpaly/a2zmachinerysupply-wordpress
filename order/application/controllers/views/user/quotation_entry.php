                ...
                <table class="table">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <input type="text" name="product_description" required="" class="form-control" autofocus="" placeholder="Example: 6202 ZZ NTN JAPAN BALL BEARING" title="Enter your item description what you need.">
<!--                            <p class="text-muted">Enter your product details accordingly your </p>-->
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="text" name="quantity_unit" required="" class="form-control" placeholder="Example: 12" title="How many quantity you need to buy.">
